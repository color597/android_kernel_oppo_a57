/************************************************************************************
** File: - MSM8953_LA_1_0\android\kernel\drivers\input\misc\fpc1020_tee.c
** VENDOR_EDIT
...
**
** Version: 1.0
** Date created: 18:03:11,26/07/2016
** Author: Ziqing.guo@Prd.BaseDrv
** TAG: BSP.Fingerprint.Basic
**
** --------------------------- Revision History: --------------------------------
**  <author>        <data>          <desc>
**  Ziqing.guo      2016/07/26      create the file, simplify the codes and improve the compatibility part
**  Ziqing.guo      2016/07/28      add the sys node to offer the wakelock api to fingerprintd
**  Ziqing.guo      2016/07/29      add wakelock for fingerprint irq
**  Haitao.zhou     2016/08/16      fix file format
**  Ziqing.guo      2016/09/09      move the gpio reset from non hlos side to TA side
************************************************************************************/
