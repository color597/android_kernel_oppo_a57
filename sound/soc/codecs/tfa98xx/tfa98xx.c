...
#ifdef VENDOR_EDIT
//Ming.Liu@PhoneSw.AudioDriver, 2016/10/17, add for sharing software image
...
#ifdef VENDOR_EDIT
//Jianfeng.Qiu@PhoneSw.AudioDriver, 2016/07/26, modify for first time no sound
...
/*oppo 2016-07-20 add by zhangping for tfa9890 read Impedance */
#ifdef VENDOR_EDIT
...
#endif
/*oppo 2016-07-20 add by zhangping for tfa9890 read Impedance end */
struct tfa98xx_rate {
    unsigned int rate;
    unsigned int fssel;
};
...
#ifdef VENDOR_EDIT
//Jianfeng.Qiu@PhoneSw.AudioDriver, 2016/07/11, Add for support rate without check profile
...
#ifdef VENDOR_EDIT
//John.Xu@PhoneSw.AudioDriver, 2015/12/24, Add for avoid pop when start
static void vol_gradual_change(struct work_struct *work)
{
	...
	if((val & TFA98XX_AUDIO_CTR_VOL_MSK) <= 0x4000 ){
	    ...
	    //John.Xu@PhoneSw.AudioDriver, 2016/02/27, Add for reduce vol for ct test
	    if(0 == tfa98xx_profile) {
            pr_err("%s: reduce music vol because it is ct test build\n", __func__);
            ret = snd_soc_write(tfa98xx->codec, TFA98XX_AUDIO_CTR, (0x0D00& (TFA98XX_AUDIO_CTR_VOL_MSK)));
	    } else {
                     ...
                     size_t count, loff_t *ppos)
{
	...
	/*oppo 2016-08-18 add by zhangping for remove the thread of monitor*/
	#ifndef VENDOR_EDIT
    const char mon_start_cmd[] = "monitor start";
    const char mon_stop_cmd[] = "monitor stop";
	#endif
	/*oppo 2016-08-18 add by zhangping for remove the thread of monitor end*/
    int buf_size;
                   ...
                   struct snd_ctl_elem_value *ucontrol)
{
...
#endif
    struct tfa98xx *tfa98xx = snd_soc_codec_get_drvdata(codec);
	/*oppo 2016-08-17 add by zhangping for the sequence of tfa9890*/
	#ifndef VENDOR_EDIT
    unsigned int base_addr_inten = TFA_FAM(tfa98xx->handle,INTENVDDS) >> 8;
	#endif
	/*oppo 2016-08-17 add by zhangping for the sequence of tfa9890*/
    ...
    mutex_unlock(&tfa98xx->dsp_lock);
	#endif
	/*oppo 2016-08-17 add by zhangping for the sequence of tfa9890 end*/
...
#ifndef VENDOR_EDIT
//Jianfeng.Qiu@PhoneSw.AudioDriver, 2016/07/11, Modify for support rate without check profile
...
/*oppo 2016-06-23 add by zhangping for the sequence of tfa9890*/
#ifdef VENDOR_EDIT
...
#endif
/*oppo 2016-06-23 add by zhangping for the sequence of tfa9890 end*/
...
/*oppo 2016-07-05 add by zhangping for speak no sound on phone*/
#ifndef VENDOR_EDIT
        .symmetric_channels = 1,
#endif
/*oppo 2016-07-05 add by zhangping for speak no sound on phone end*/
...
static int tfa98xx_remove(struct snd_soc_codec *codec)
{
	...
	/*oppo 2016-08-17 add by zhangping for remove the thread of monitor*/
	#ifndef VENDOR_EDIT
    cancel_delayed_work_sync(&tfa98xx->monitor_work);
	#endif
	/*oppo 2016-08-17 add by zhangping for remove the thread of monitor end*/
    cancel_delayed_work_sync(&tfa98xx->init_work);
    cancel_delayed_work_sync(&tfa98xx->tapdet_work);
	#ifdef VENDOR_EDIT
	//John.Xu@PhoneSw.AudioDriver, 2015/12/24, Add for avoid pop when start
                 ...
                 const struct i2c_device_id *id)
{
    ...
    /*OPPO 2016-06-14 zhzhyon@AudioDriver Add for tfa9890 resource*/
    #ifdef VENDOR_EDIT
    tfa98xx->tfa98xx_vdd = regulator_get(&i2c->dev, "tfa9890_vdd");
    if (IS_ERR(tfa98xx->tfa98xx_vdd))
    {
        printk("regulator ak4376-tvdd get failed\n ");
    ...
    #endif
    /*OPPO 2016-06-14 zhzhyon@AudioDriver Add end*/
