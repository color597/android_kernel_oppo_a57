...
#ifdef VENDOR_EDIT
//Fuchun.Liao@Mobile.BSP.CHG 2016/06/03 add for new prop
...
#ifdef VENDOR_EDIT
//Fuchun.Liao@Mobile.BSP.CHG 2015-08-24 add new prop
...
#endif /*VENDOR_EDIT*/
#ifdef VENDOR_EDIT
//Fuchun.Liao@Mobile.BSP.CHG 2016-08-24 add new prop
	POWER_SUPPLY_PROP_PRIMAL_PROPERTY,
#endif /* VENDOR_EDIT */
#ifdef VENDOR_EDIT
//Fuchun.Liao@Mobile.BSP.CHG 2016-11-21 add for shipmode
	POWER_SUPPLY_PROP_SHIP_MODE,
#endif /* VENDOR_EDIT */
#ifdef VENDOR_EDIT
// wenbin.liu@BSP.CHG.Basic, 2017/11/06 Add for short c detect
