...
enum pon_restart_reason {
	...
	#ifdef VENDOR_EDIT //yixue.ge@bsp.drv modify all the reboot mode as hardware reboot
	PON_RESTART_REASON_SILENCE			= 0x07,
	PON_RESTART_REASON_SAU				= 0x08,
	PON_RESTART_RF_MODE					= 0x09,
	PON_RESTART_WLAN_MODE				= 0x0A,
	PON_RESTART_MOS_MODE				= 0x0B,
	PON_RESTART_FACTORY_MODE			= 0x0C,
	PON_RESTART_REBOOT_KERNEL			= 0x0D,
	PON_RESTART_REBOOT_MODEM			= 0x0E,
	PON_RESTART_REBOOT_ANDROID			= 0x0F,
	PON_RESTART_REBOOT_NORMAL			= 0x3F,
	#endif
};
