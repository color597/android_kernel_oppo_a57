...
static int oppo_uartlog_disable = 0;
#else
static int oppo_uartlog_disable = 1;
#endif
static int oppo_uartlog_set(char *str)
{
	if(str != NULL){
		oppo_uartlog_disable = !!simple_strtol(str, NULL, 0);
	}
	return 1;
}
__setup("oppo_uartlog_disable=", oppo_uartlog_set);
#endif
...
//yixue.ge@bsp.drv 20160204 add for disable uart print
//this modify can reduce poweron time add ftm mode
		if (oppo_uartlog_disable&&(con->flags & CON_CONSDEV))
			continue;
#endif
